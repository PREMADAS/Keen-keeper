...
const Footer = () => {
    return (
        <div>
            <footer className="bg-[#244d3f] text-gray-100 py-8 md:py-10 px-4 md:px-6"> {/* ✅ CHANGED: py-10 → py-8 md:py-10, px-6 → px-4 md:px-6 */}
                <div className="max-w-6xl mx-auto space-y-8">

                    <div>
                        <h2 className="text-2xl md:text-3xl font-bold text-center">KeenKeeper</h2> {/* ✅ CHANGED: text-3xl → text-2xl md:text-3xl */}
                        <p className="mt-2 text-gray-300 text-[13px] text-center px-2 md:px-0"> {/* ✅ CHANGED: added px-2 md:px-0 */}
                    ...
                    <div className="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400 gap-2 md:gap-0"> {/* ✅ CHANGED: added gap-2 md:gap-0 */}
                        <p className="text-center md:text-left">© 2026 KeenKeeper. All rights reserved.</p> {/* ✅ CHANGED: added text-center md:text-left */}
                        <div className="flex space-x-4 md:space-x-6 mt-2 md:mt-0"> {/* ✅ CHANGED: class → className, space-x-6 → space-x-4 md:space-x-6, mt-4 → mt-2 */}
